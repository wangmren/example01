        ...
        for li in li_list:
            ...
            if info_str:
                ...
                if len(info_arr)==7:
                    ...
                    item['floor_type']=info_arr[6].strip()#楼的类型
                else:
                    item['model']=item['area']=item['direction']=item['zhuangxiu']=item['floor']=item['createtime']=item['floor_type']=None
                    #总价
                ...
                #单价
                unitPrice_list = li.xpath('.//div[@class="unitPrice"]/span/text()')
                [0][0:-3]
